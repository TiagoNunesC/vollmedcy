...
describe('Usuário logado na página de dashboard', () => {
    ...
    context('Modal de cadastro de especialista', () => {
        ...
        it('Seleciona o botão de checkbox "Atende por plano?" para visualizar os planos de saúde', () => {
            cy.visit('/dashboard')
            cy.contains('Cadastrar especialista').should('be.visible').click()
        ...
        it('Seleciona o botão de checkbox "Atende por plano?" após preenchimento do formulário para visualizar os planos de saúde', () => {
